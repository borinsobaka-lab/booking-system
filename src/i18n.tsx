...
const DICT: Dict = {
  ...
  'label.address': { en: 'Address', ka: 'მისამართი', ru: 'Адрес' },
  ...
  'cal.add': { en: 'Add to calendar', ka: 'კალენდარში დამატება', ru: 'Добавить в календарь' },
  'cal.google': { en: 'Google', ka: 'Google', ru: 'Google' },
  'cal.apple': { en: 'Apple', ka: 'Apple', ru: 'Apple' },
  'cal.outlook': { en: 'Outlook', ka: 'Outlook', ru: 'Outlook' },

  'cancel.heading': { en: 'Your booking', ka: 'თქვენი ჯავშანი', ru: 'Ваша запись' },
  'cancel.loading': { en: 'Loading your booking…', ka: 'იტვირთება…', ru: 'Загружаем запись…' },
  'cancel.invalid': {
    en: 'This link is invalid or has expired.',
    ka: 'ბმული არასწორია ან ვადაგასულია.',
    ru: 'Ссылка недействительна или устарела.',
  },
  'cancel.gone': {
    en: 'This booking has already been cancelled.',
    ka: 'ეს ჯავშანი უკვე გაუქმებულია.',
    ru: 'Эта запись уже отменена.',
  },
  'cancel.button': { en: 'Cancel booking', ka: 'ჯავშნის გაუქმება', ru: 'Отменить запись' },
  'cancel.confirm': {
    en: 'Cancel this booking? This cannot be undone.',
    ka: 'გავაუქმოთ ჯავშანი? მოქმედება შეუქცევადია.',
    ru: 'Отменить запись? Действие необратимо.',
  },
  'cancel.done.title': { en: 'Booking cancelled', ka: 'ჯავშანი გაუქმდა', ru: 'Запись отменена' },
  'cancel.done.sub': {
    en: 'Your booking has been cancelled. You can book again any time.',
    ka: 'თქვენი ჯავშანი გაუქმდა. ხელახლა დაჯავშნა ნებისმიერ დროს შეგიძლიათ.',
    ru: 'Запись отменена. Вы можете записаться снова в любое время.',
  },
